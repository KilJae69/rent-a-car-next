...
export default function ReservationForm() {
  ...
  const t = useTranslations("buttonSend");
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    router.push("/reservation/vehicles", { scroll: false, locale });
  }
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="w-full rounded-lg bg-white p-4 shadow-md lg:px-8 lg:pb-4 lg:pt-6"
      >
